...
- **Tactics tab**: covers six core tactical patterns (Fork, Pin, Skewer, Discovered Attack, Back-Rank Mate, Smothered Mate) with annotated example diagrams and "how to spot it" tips.
- **Built for touch**: large tap targets, legal-move dots, a last-move arrow, gold selection ring, board flip, and locked zoom/scroll so it feels native on iPad.
