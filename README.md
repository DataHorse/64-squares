...
- **Three board themes**: Classic Wood, Modern Minimal (the default), Cyberpunk Neon — switch instantly, no reload.
- **Piece Moves lessons**: a dedicated tab that visually teaches how every piece moves — including special rules like castling, en passant, and promotion — with diagrams generated by the app's own rules engine, so every highlighted square is verified-correct.
- **Tactics & Strategy lessons**: a second tab covering six core tactical patterns (Fork, Pin, Skewer, Discovered Attack, Back-Rank Mate, Smothered Mate) with annotated example diagrams and "how to spot it" tips.
